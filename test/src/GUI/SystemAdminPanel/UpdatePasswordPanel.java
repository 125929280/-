                        ...
                        public void actionPerformed(ActionEvent e) {
                                if (String.valueOf(oldPassword.getPassword()).equals("")
                                        ...
                                        JOptionPane.showMessageDialog(null, "请继续输入", "消息提示",
                                                ...
                                                .equals(systemAdmin.getPassword("admin")) == false) {
                                        JOptionPane.showMessageDialog(null, "旧密码错误", "消息提示",
                                                        JOptionPane.WARNING_MESSAGE);
                                        oldPassword.setText("");
                                        newPassword.setText("");
                                        ...
                                        systemAdmin.updatePassword("admin", String.valueOf(newPassword.getPassword()));
