...
public class UpdatePasswordPanel extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UpdatePasswordPanel frame = new UpdatePasswordPanel("123");
	 ...
	 * Create the frame.
	 */
	public UpdatePasswordPanel(String username) {
		...
		confirmUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (String.valueOf(oldPassword.getPassword()).equals("")
				...
				} else if (String.valueOf(oldPassword.getPassword()).equals(admin.getPassword(username)) == false) {
					JOptionPane.showMessageDialog(null, "原密码错误", "消息提示", JOptionPane.WARNING_MESSAGE);
					oldPassword.setText("");
					newPassword.setText("");
					...
					admin.updatePassword(username, String.valueOf(newPassword.getPassword()));
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup().addGap(83)
								...
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
										.addComponent(oldPassword).addComponent(newPassword)
										.addComponent(repeatPassword, GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE)))
						.addGroup(gl_contentPane.createSequentialGroup().addGap(171).addComponent(confirmUpdate)))
				.addContainerGap(141, Short.MAX_VALUE)));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup().addContainerGap()
						.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
								.addComponent(oldPassword, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(label))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
								.addComponent(newPassword, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
						...
						.addGap(44).addComponent(confirmUpdate).addContainerGap(47, Short.MAX_VALUE)));
